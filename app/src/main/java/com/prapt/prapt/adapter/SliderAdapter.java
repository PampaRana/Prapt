...
public class SliderAdapter extends SliderViewAdapter<SliderAdapter.SliderAdapterViewHolder> {
    ...
    private final List<BannerDataDetails> mSliderItems;
    Context context;
    // Constructor
    public SliderAdapter(Context context, ArrayList<BannerDataDetails> sliderDataArrayList) {
    ...
    public void onBindViewHolder(SliderAdapterViewHolder viewHolder, final int position) {
        ...
        final BannerDataDetails sliderItem = mSliderItems.get(position);
